    ...
    def __init__(self):
        try:
            ...
            if "CUDA out of memory" in str(e):
                print("⚠️ Reranker too big for GPU → using CPU instead")
...
class Classifier:
    def __init__(self):
        ...
        try:
            ...
            if "CUDA out of memory." in str(e):
                print("⚠️ Classifier too big for GPU → using CPU instead")
    ...
    def classify(self, claim, top_evidence):
        ...
        try:
            # Process evidence in smaller batches to avoid memory issues
...
class summarizer:
    def __init__(self):
        ...
        try:
            ...
            if "CUDA out of memory" in str(e):
                print("⚠️ Summarizer too big for GPU → using CPU instead")
                self.device = torch.device("cpu")
